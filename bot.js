...
if (message.content === '*help') {
         let embed = new Discord.RichEmbed()
.setThumbnail(message.author.avatarURL)    
      .addField("** مبرمج البوت :wrench: **","**@! ♛✈☬iRealKsA♕ |🙞👑🙞#4597  **")
.setColor('RANDOM')
  message.author.sendEmbed(embed);
    }
});
...
client.on('ready', () => {
   console.log(`----------------`);
      console.log(`irealksa - Script By : ireaksa`);
        console.log(`----------------`);
      console.log(`ON ${client.guilds.size} Servers '     Script By : iRealKsA♕ ' `);
    console.log(`----------------`);
  console.log(`Logged in as ${client.user.tag}!`);
...
const secreT = [
  ...
  "**نحن نكتب ما لا نستطيع ان نقول وما نريد ان يكون**.", 
  "**الليل هذا قاسي  عليّ ابي أمان حضنك شويء:frowning2: **.",
]
...
const Ex = [
	 ...
	 'Ex | *** والان يقوم برسال Friends الى *** ||@! ♛✈☬iRealKsA♕ |🙞👑🙞#4597||',
	 'Ex | *** بعد رسال طلب صدقاء الى *** <! @♛✈☬iRealKsA♕ |🙞👑🙞#4597> *** يقوم بتنفذ طلب الذى سيتم رسال الك ***',
 ...
 if (message.content.startsWith('*ex')) {
  ...
  .setTitle("** __لعبة سيرفر شباب المملكة الحوت الأزرق__ **")
  .setColor('#FFA500')
  ...
  .setImage("https://www.copts-united.com/uploads/3337/59_20180421211325.jpg")
   ...
   message.react("??")// تم صنع اللعبة من قبل iRealKsA♕
 }
});
       ...
       message.delete() 
          ...
          if (message.content.startsWith("kick")) {
             ...
             member.kick().then((member) => {
                 ...
                 title: 'بسبب النشر ' + member.displayName + ' مبروك احلى كيك ياحياتي', 
                 color: 490101,
                 }
               });
           }  /////////////// iRealKsA♕
...
message.channel.send("`Error`:" + Julian)
  ...
  client.on('typingStart', (ch, user) => {
    if(user.presence.status === 'offline') {
        ...
        ch.send(`${user} ليه حاط نفسك اوف لاين ياقليل الأدب؟`)
        .then(msg => {
            msg.delete(10000)
        })
    }
...
if(!user.bot) return msg.reply('\`@♔♕Shbab ALmmLkh♔♕#1243 \`');
